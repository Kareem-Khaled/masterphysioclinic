  ...
  const doctors = [
    {
      ...
      specialization: ['تأهيل الأطفال', 'العلاج الطبيعي المتقدم'],
      ...
      expertise: [
        'تقييم الأطفال بمعيار GMFM المعتمد على نقاط القوة والتحديات الظاهرة في تطور الطفل',
        'العلاج بطريقة NDT المتقدمة للأطفال',
        'العلاج بأستخدام اساليب للحد من التشنج مثل البروتوكولات الحركية المكثفة وتمارين التحكم العضلي',
        'تأهيل حالات الأطفال (الشلل الدماغي - التأخر الحركي - المتلازمات الجينية)',
        'تأهيل المشاكل العضلية والهيكلية لدى الأطفال (جميع اضطرابات المشي - انحرافات العمود الفقري)',
        'تأهيل قبل ومابعد العمليات الجراحية للاطفال (الكسور - تطويل الأوتار - تصحيح القدم)',
      ],
    },
    {
      name: 'د/ عبدالرحمن الجهمي',
      image: `${import.meta.env.BASE_URL}Doctors/2.jpg`,
      specialization: ['تأهيل الأطفال', 'الأعصاب', 'العلاج اليدوي'],
      ...
      expertise: [
        ...
        'تأهيل المشاكل العضلية والهيكلية لدى الأطفال (جميع اضطرابات المشي - انحرافات العمود الفقري)',
        'تأهيل قبل ومابعد العمليات الجراحية للاطفال (الكسور - تطويل الأوتار - تصحيح القدم)',
        'تأهيل مشاكل الاتزان والدوار الناتج عن اضطرابات الاذن',
        'تأهيل مرضى الأعصاب (الجلطات - التصلب اللويحي - متلازمة غيلان باريه)',
      ],
    },
    {
      name: 'د/ عبدالله الشنقيطي',
      image: `${import.meta.env.BASE_URL}Doctors/3.jpg`,
      specialization: ['تأهيل الأطفال', 'العلاج العصبي', 'العظام'],
      ...
      expertise: [
        'العلاج بطريقة NDT المتقدمة للأطفال',
        'العلاج بأستخدام اساليب العلمية الحديثة للحد من التشنج مثل البروتوكولات الحركية المكثفة وتمارين التحكم العضلي',
        'تأهيل حالات الأطفال (الشلل الدماغي - التأخر الحركي - المتلازمات الجينية)',
        'تأهيل قبل ومابعد العمليات الجراحية للاطفال (الكسور - تطويل الأوتار - تصحيح القدم)',
        'تأهيل مشاكل الجهاز العضلية الهيكلي (آلام أسفل الظهر وإصابات الركبة)',
      ],
    },
    {
      ...
      expertise: [
        'تأهيل الإصابات الرياضية (تمزق في العضلات - التواء الكاحل)',
        'تأهيل المشاكل العضلية والهيكلية (خشونة الركبة والمفاصل - الانزلاق الغضروفي لأسفل الظهر)',
        'تأهيل قبل ومابعد العمليات الجراحية (عمليات الركبة - عمليات تغير مفاصل)',
        'تأهيل ما بعد الإصابات العصبية (تأهيل الجلطات - إصابات الدماغ)',
        'علاج الوذمة اللمفاوية (على نهج المدرسة التشيكية واليابانية)',
      ],
    },
    {
      name: 'د/ أحلام الحربي',
      ...
      certifications: [
        ...
        'ممارس معتمد في تأهيل الإصابات الرياضية',
        'ممارس معتمد في إدارة الألم بالعلاج الحركي والتمارين العلاجية',
        'ممارس معتمد في التقييم السريري والعلاج المبني على الدليل العلمي',
      ],
      expertise: [
        'علاج وتأهيل مشاكل قاع الحوض أثناء الحمل، وقبل وبعد الولادة',
        'تأهيل وتقوية عضلات الكور وتحسين الاستقرار الحركي',
        'تأهيل ما قبل وبعد العمليات الجراحية',
        'علاج وتأهيل المشاكل العضلية والهيكلية للكبار والأطفال',
        'تأهيل الحالات العصبية للأطفال والكبار (الجلطات الدماغية، التصلب اللويحي، اعتلالات الأعصاب)',
        'تحسين وظيفة اليد وتنمية المهارات الحركية الدقيقة',
      ],
    },
  ];
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl p-6 space-y-4">
                      ...
                      {doctor.expertise && (
                        <div className="flex items-start space-x-3">
                          <Stethoscope size={24} className="text-teal-600 mt-1 flex-shrink-0" />
                          <div>
